...
![Random Forest Results](figures/best_rf_results.png)

![Logistic Regresssion Results](figures/best_lr_results.png)
...
They also achieved impressive ROC-AUC scores of 0.99 and 0.88 respectively, as seen above.
This implies that the models are performant at any given threshold for classification.
...
![RF Feature Importance](figures/feature_importance.png)

<!-- ![Logistic Regression RFECV results](figures/logreg_RFECV.png) -->
...
We can see this in the graph above, displaying the importance of each feature in the Random Forest Classification model as determined by probing a trained tree.
...
Lexical diversity is a measure of the amount of different words/sub-word units (tokens) in a text compared to the total amount of words in the text.
Word choice marks how often certain classes of words are used.
This is important, as these features *can* be roughly approximated at a glance by a human, suggesting that, with training, one could reliably discern between automatically-generated text and human-written text.
